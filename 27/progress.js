// Сделать содержание как в википедии как минимум 2 уровня вложенности h1 h2 Нажатие должно прокручивать до соответсвующего хэдера
...
const mock = () => {
  ...
  window.addEventListener("load", () => {
    ...
    window.addEventListener("6", throttledHandler);
  /*
