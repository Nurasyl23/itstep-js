// Ограничить визуальное положение элемента рамками контейнера в drag-n-drop
// Добавить в слайдер пролистывание мышкой
// 3*. "пазл" из нарезанной на полоски картинки // backround-position
...
const startDrag = (item) => (event) => {
  ...
  currentItem.style.transform = "translate(" + 0 + "px," + y + "px)";
}

const drag = (event) => {
   
   // чтобы выключить выделение текста
   if (currentItem === null) {
    return;
  }
